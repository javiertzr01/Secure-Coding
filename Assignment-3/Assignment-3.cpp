...
When do I use storevalue and when do I use addtosolver?
When do I have to deference first before accessing/writing? How do I write p = &a. Change value of a?
...
void Z3ExampleMgr::test4(){
    ...
    //  p = malloc;
    expr mem_p = getMemObjAddress("malloc");
    addToSolver(p == mem_p);
...
void Z3ExampleMgr::test5(){
    ...
    //  p = malloc;
    expr mem_p = getMemObjAddress("malloc_p");
    addToSolver(p == mem_p);
...
void Z3ExampleMgr::test7(){
    ...
    // std::cout<< getEvalExpr(y == getZ3Expr(2)) << "\n";
